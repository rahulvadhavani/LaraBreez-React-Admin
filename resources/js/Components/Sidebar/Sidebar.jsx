...
export const SidebarLink = ({
    ...
    const baseClasses = `p-2 w-full flex items-center gap-2 rounded-md transition-colors duration-200`
    const activeClasses =
        'text-white bg-gray-800 shadow-lg hover:bg-gray-700 dark:bg-gray-100 bg-gray-100 dark:text-gray-700 dark:hover:text-gray-800 dark:hover:bg-gray-300'
    const unActiveClasses =
        'text-gray-700 hover:text-gray-800 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600'
