...
export const SidebarLink = ({
    ...
    const activeClasses =
        'text-white bg-gray-800 shadow-lg hover:bg-gray-600 dark:bg-gray-100 bg-gray-100 dark:text-gray-700 dark:hover:text-gray-500 dark:hover:bg-gray-200'
    const unActiveClasses =
        'text-gray-500 hover:text-gray-700 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-200  hover:dark:text-gray-200 dark:hover:bg-gray-600'
